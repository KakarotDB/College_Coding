...
public class A_1_1 {
    public static void main(String[] args) throws IOException {
         ...
         * choose a position between two 1's 
         * si-1 = 1, si+1 = 1
         * set si to either 0/1
         * Find min and max of 1's that can be in the resulting string 
         * 
         * We can only work with a group of "101" or "111"
         * 
         * 100101101
         * 101010101
         * 
        ...
        while (t-- > 0) {
            ...
            int count = 0;
            for (int i = 1; i < n - 1; i++) {
                if (s.charAt(i - 1) == s.charAt(i + 1) && s.charAt(i - 1) == '1') {
                    count++;
                }
            }
            pw.println((count1 - count) + " " + (count1 + count));
        }
        pw.flush();
        pw.close();
        br.close();
