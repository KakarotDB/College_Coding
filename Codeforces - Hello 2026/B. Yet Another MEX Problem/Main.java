    ...
    public static void main(String[] args) throws IOException {
        ...
        */
        while (t-- > 0) {
            ...
            /*
            number of operations = n - k + 1
            we have to find the mex after all the operations
            maximization problem
            maximize the mex
            so look at windows of size k, find the maximum mex among all windows
            for the window with maximum mex, choose some i in that window to remove
            ans = min(global mex, k- 1)
             */
