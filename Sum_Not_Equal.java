...
class Sum_Not_Equal {
    public static void main(String[] args) throws IOException {
         ...
         * 
         * we need to find three indexes such that 
         * Ai + Aj != Ak
         * basically the sum of two indices is not equal to the third one 
         * 
         * How can we do this efficiently (n log n)
         * 
         * let's take three numbers x y z 
         * 
         * x + y = z 
         * y + z = x
         * x + z = y 
         * 
         * only possible when x=y=z=0
         * 
         * 
         */
        test: 
