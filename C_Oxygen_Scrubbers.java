...
class C_Oxygen_Scrubbers {
    public static void main(String[] args) throws IOException {
         ...
         * 
         * 2 units wide, h units tall 
         * we have a total of n oxygen cannisters
         * the ith canister has 1 unit width and ai height
         * 
         * we can install horizontal shelves anywhere within this rack 
         * 
         * No stacking canisters on top of one another 
         * 
         * We need to find largest k such that : 
         *  we can take prefix of first k canisters and fit them all into the h-tall
         * rack simultaneously 
         * 
         * After selecting the greatest k, we can rearrange them in any order to minimize the height
         * 
         * The arrival sequence matters initially, after that we can rearrange
         * 
         * 
         * 
         */
    ...
    public static boolean canFit(long k, List<Long> list, long h) {
