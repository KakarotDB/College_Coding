...
class A_Flip_Flops {
    public static void main(String[] args) throws IOException {
         ...
         * 
         * n monsters
         * each monster has combat power a[i]
         * otterZ has combat power of c
         * 
         * he has k f/fs, can perform the following operations : 
         *  Kill alive monster, if ai<=c, c+=ai
         *  Throw f/f at an aliv emonster i, the f/f with be rboken and the monster will become angerier then ai becomes ai+1 
         * 
         * so basically we try to use as many flip flops as possible to increase each monster's power till we reach c, and increase c+=c = c*=2;
         * 
         * 
         */
        test: 
