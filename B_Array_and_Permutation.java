...
public class B_Array_and_Permutation {
    public static void main(String[] args) throws IOException {
         ...
         * pi+1 = pi
         * 
         * so if the permutation is like : 
         * 1 2 3 4 
         * we can have arrays a like : 
         * 2 2 3 4 
         * 1 2 2 4 
         * 1 2 4 4 
         * 1 3 3 4 
         ...
         * a = 3 3 3 5 4
         * 
         * Relative ordering stays the same. 
         * 
         * 
         */
        test: 
        while (t-- > 0) {
            ...
            while (ptrP < p.size() && ptrA < a.size()) {
                if (p.get(ptrP).equals(a.get(ptrA))) {
                    ptrA++;
                }
                ptrP++;
            }
