...
class B_Array {
    public static void main(String[] args) throws IOException {
         ...
         * 
         * For each index i:
         *  Find maximum number of indices j such that j > i and 
         *  |ai - k| > |aj - k| over all possible integer values of k 
         * 
         * O(n^2) is plausible 
         * 
         * Thinking in number lines :
         *  The distance between k and ai, is greater than the distance between k and aj
         * 
         * So bsaically the number k is closer to aj than it is to ai 
         * 
         ...
         * Case 1 : ai < aj
         *  k > (ai + aj) / 2
         *  so L = floor(ai + aj / 2) + 1
         *  k's can be in the range (L, inf)
         * 
         * Case 2: aj > ai
         *  k < midpoint
         *  k = (-inf, ceil(ai + aj / 2) + 1)
         *  
         * 
         */
        test: 
        while (t-- > 0) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                for (int j = i + 1; j < n; j++) {
                    if (a.get(i) < a.get(j)) {
                        left++;
                    } else if(a.get(i) > a.get(j)) right++;
                }
                ans.add(max(left, right));
