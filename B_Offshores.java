...
public class B_Offshores {
    public static void main(String[] args) throws IOException {
         ...
         * 
         * n diferent banks
         * ith bank has ai amount 
         * 
         * He wants to gather all money into one bank 
         * 
         * x amount in one transfer 
         * y rubles credited to other account 
         * 
         * total amount transferrable = x - y 
         * 
         * we preferably would want to transfer less amount of times 
         * get the maximum amount possible transferred to one single bank account 
         * 
         * Ai -> Ai / x = count transfers are possible 
         * amount transferred = count * y 
         * Ai % x is left in bank 
         * 
         * Amount each bank can transfer = (ai / x) * y 
        ...
        while (t-- > 0) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                potential = potential + (a.get(i) / x) * y;
            }
            long ans = 0;
            for (int i = 0; i < n; i++) {
                long current = potential - (a.get(i) / x) * y + a.get(i);
                ans = max(current, ans);
            }
            pw.println(ans);
        }
